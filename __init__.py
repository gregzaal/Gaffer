                    ...
                    if self.show_hdri_list:
                        ...
                        for name in hdris:
                            ...
                            if len(variations) >= 10:
                                ...
                                row.label(text='There are quite a few varations of this HDRI, maybe they were wrongly detected?', icon='QUESTION')
                                row = col.row()
                                row.alignment = 'CENTER'
                                op = row.operator('wm.url_open', text="Click here to learn how to fix this", icon='WORLD')
