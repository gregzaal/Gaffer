...
class GafferPreferences(bpy.types.AddonPreferences):
    ...
    include_8bit: bpy.props.BoolProperty(
        ...
        description=(
            "Include LDR images like JPGs and PNGs when searching for files in the HDRI folder. "
...
class GafferProperties(bpy.types.PropertyGroup):
    ...
    LightRadiusDrawType: bpy.props.EnumProperty(
        ...
        default="dotted",
        items=(
            ("filled", "Filled", "Draw a circle filled with a solid color"),
    ...
    DefaultRadiusColor: bpy.props.FloatVectorProperty(
        name="Default Color",
        description=(
            "When 'Use Color' is disaled, or when the color of a light is unknown "
    ...
    LabelDrawType: bpy.props.EnumProperty(
        ...
        items=(
            (
                "color_bg",
                "Colored background, plain text",
                "Show the label name on a colored background",
            ),
            (
                "plain_bg",
                "Colored text in plain background",
                "Show the label name in color, on a plain background",
            ),
            (
                "color_text",
                "Text only, no background",
                "Show the text without any background",
            ),
        ),
    )
    ...
    LabelAlign: bpy.props.EnumProperty(
        ...
        default="r",
        items=(
            ("c", "Centered", "Positioned exactly on the light"),
